<x-layout>
    ...
    <div class="flex justify-center  gap-40 mt-12 mb-12 items-baseline-last text-center">
        ...
        <div class="flex flex-col items-center space-y-5">
            <img src="https://babli.in/cdn/shop/files/sustainable.png?v=1698319023&width=79" alt="Handmade">
            <p class="text-sm">SUSTAINABLY SOURCED</p>
        </div>
        <div class="flex flex-col items-center space-y-5">
            <img src="	https://babli.in/cdn/shop/files/5.png?v=1698305851&width=128" alt="Handmade">
